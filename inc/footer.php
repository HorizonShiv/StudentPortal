...
<script>
  function notGenerated() {
    alert("Not approved yet!! To see detail click on Eye Button");
  }
</script>
  ...
  $(function() {
    ...
    var doughnutPieData = {
     ...
     var doughnutPieData1 = {
      datasets: [{
        data: [<?php echo $lab_complaints_pending . "," . $lab_complaints_inProgress . "," . $lab_complaints_completed;  ?>],
        backgroundColor: [
          // "rgba(255, 99, 132, 0.5)",
          // "rgba(255, 206, 86, 0.5)",
          // "rgba(54, 162, 235, 0.5)",
      ...
      // These labels appear in the legend and in the tooltips when hovering different arcs
      labels: ["Pending Complaints", "In-Progress Complaints", "Completed Complaints"],
    };

    var doughnutPieData2 = {
      datasets: [{
        data: [<?php echo $class_complaints_pending . "," . $class_complaints_inProgress . "," . $class_complaints_completed;  ?>],
        backgroundColor: [
          // "rgba(255, 99, 132, 0.5)",
          // "rgba(255, 206, 86, 0.5)",
          // "rgba(54, 162, 235, 0.5)",
    ...
    var doughnutPieData3 = {
      datasets: [{
        data: [<?php echo $library_complaints_pending . "," . $library_complaints_inProgress . "," . $library_complaints_completed;  ?>],
        backgroundColor: [
          // "rgba(255, 99, 132, 0.5)",
          // "rgba(255, 206, 86, 0.5)",
          // "rgba(54, 162, 235, 0.5)",
