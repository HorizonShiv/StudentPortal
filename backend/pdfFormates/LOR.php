...
<table width="100%" style="margin: 100px 0px 50px 0px;">
    <tr>
        ...
        <th align="left"><strong>SETI/LOR/'.$document_process_id.'/'.date("Y").'</strong></th>
        <th align="center"></th>
        <th align="right"><strong>Date: '.date("d-m-Y").'</strong></th>
        </td>
    </tr>
</table><div align="center"><u><strong>LETTER OF RECOMMENDATION</strong></u></div>
