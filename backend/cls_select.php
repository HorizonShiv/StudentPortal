...
class GetComplaint
{
    ...
    public function ComplaintGetByMonth()
    {
        ...
        $sql = "SELECT COUNT(*) as 'complaint', MONTHNAME(date) as 'month' 
                FROM complaint 
                WHERE DATE_FORMAT(date, '%Y-%m') BETWEEN '$sDate' and DATE_FORMAT(CURDATE(), '%Y-%m') 
                GROUP BY MONTHNAME(date), DATE_FORMAT(date, '%Y-%m')";
...
class Get
{
    ...
    public function documentProcessStudentById()
    {
        ...
        $sql = "SELECT * FROM `documets_process` WHERE  `student_id`='$this->user_id' && `dp_id`='$this->dp_id'";
        $result = $conn->query($sql);
        return $result;
    }
    ...
    public function GetFooterStamp()
    {
        $conn = dbconnection();

        $sql = "SELECT * FROM `FooterStamp` WHERE `userId`='$this->user_id'";
        $result = $conn->query($sql);
        return $result;
    }

    public function GetStudetnById()
    {
        $conn = dbconnection();
    ...
    public function GetFooterStampByClg()
    {
        $conn = dbconnection();

        // $sql = "SELECT * FROM `FooterStamp` WHERE `userClgId`='$this->UserIdForFooter' && `userId`='$this->clg_id' ";
        $sql = "SELECT * FROM `FooterStamp` WHERE `userId`='$this->UserIdForFooter' && `userClgId`='$this->clg_id'";
        $result = $conn->query($sql);
        return $result;
    }
}
