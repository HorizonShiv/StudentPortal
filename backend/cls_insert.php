...
class AddFooterStamp
{
    ...
    public function FooterStamp()
    {
        $conn = dbconnection();

        $sql = "INSERT INTO `FooterStamp`(`userId`, `userName`, `userPosition`, `userClgId`, `userClg`, `userMail`, `userNumber`) VALUES ('$this->UserId','$this->UserName','$this->UserPosition','$this->UserClgId','$this->UserClg','$this->UserMail','$this->UserNumber')";
        $result = $conn->query($sql);
