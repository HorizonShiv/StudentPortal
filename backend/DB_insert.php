...
// }
elseif(isset($_POST['FooterStamp'])){
    ...
    $UserClgId=$_POST['UserClgId'];
    $UserName=$_POST['UserName'];
    $UserPosition=$_POST['UserPosition'];
    $UserClg=$_POST['UserClg'];
    $UserMail=$_POST['UserMail'];
    $UserNumber=$_POST['UserNumber'];

    $obj = new AddFooterStamp();
    $obj->UserId = $UserId;
    $obj->UserName = $UserName;
    $obj->UserPosition = $UserPosition;
    $obj->UserClgId = $UserClgId;
    $obj->UserClg = $UserClg;
    $obj->UserMail = $UserMail;
    $obj->UserNumber = $UserNumber;
    $result = $obj->FooterStamp();
