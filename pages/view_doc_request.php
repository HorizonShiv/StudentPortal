                                ...
                                <table class="table table-hover" id="table_data">
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    <?php 
                                                        if ($row['faculty_status']==0 && $row['student_department_status']){
                                                        ...
                                                        }elseif ($row['student_department_status']==0){
                                                ...
                                                <td>
                                                    <?php 
                                                        ...
                                                        if($row['doc_path']=="" || $row['doc_path']==null){
                                                            ...
                                                            echo '<a class="actionBtnPrimary" href="'.$row['doc_path'].'"><i class="mdi mdi-eye"></i></a>';
                                                        }
