                            ...
                            <div class="col-md-12 grid-margin stretch-card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-1">
                                            <?php if(isset($_SESSION['student'])==false && isset($_SESSION['faculty'])==false && isset($_SESSION['aditya'])==false): ?>
                                            <h6><a href="../pages/view_doc_request.php?id=<?php echo $_GET['id'] ?>" class="btn btn-inverse-primary btn-sm">Go Back</a></h6>
                                            <?php endif; ?>

                                            <?php if(isset($_SESSION['student'])==true || isset($_SESSION['faculty'])==true || isset($_SESSION['aditya'])==true): ?>
