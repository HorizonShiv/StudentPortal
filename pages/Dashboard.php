            ...
            <div class="row">
              <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                <h3 class="font-weight-bold">Welcome
                  ...
                  ?></h3> <h6>Sal Education - Campus Connect</h6>
              </div>
            </div>
          </div>
        </div>
        ...
        if (isset($_SESSION['Admin']) == true || isset($_SESSION['manager']) == true) {
          ...
          if ($result_complaint->num_rows > 0) {
            ...
            foreach ($result_complaint as $row) {
              ...
              elseif ($row['status'] == 0 && $row['cat_type']==1) {
        ...
        ?>
                          ...
                          <div class="col-md-12 col-xl-12">
                            <div class="row">
                              <div class="col-md-10 border-right">
                                <div class="table-responsive mb-3 mb-md-0 mt-3">
                                  <h3>
                                    Notice Board is vacant
                                    <small class="text-muted">
                                      Whenever some add anything in notice you will find it here
                                    </small>
                                  </h3>
                                  <br>
          ...
          <div class="row">
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Lab Complaints</h4>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Class Complaints</h4>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Library Complaints</h4>
